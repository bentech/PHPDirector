...
<div class='left'>
	<div class="left_articles">
		<div class="buttons">
			<p align="center"><a href="videos.php?id={id}" class="bluebtn">View</a>
			<a href="videopop.php?KeepThis=true&amp;height=530&amp;width=430&amp;id={id}"class="thickbox greenbtn" rel="gallery-videos" title="{name}">Popup</a></p>
		</div>
		<div class="calendar"><p>{date-mon}<br />(date-day}</p></div>
			<h2><a href="videos.php?id={id}">{name}</a></h2>
